    ...
    return (
        <div className='storyvideo-wapper'>
            <div className="header">
                <div className="logo">
                    <svg aria-label="Instagram" className={"svg "} color="#fff" fill="#fff" height="29" role="img" viewBox="32 4 113 32" width="103" >
            ...
            <div className="content">
                ...
                <div className='back-btn' onClick={() => onGoBack()}>
                    <svg aria-label="Go Back"
                        style={{ rotate: "-90deg" }}
                        color="#fff" fill="#fff" height="20"
                ...
                <div className='next-btn' onClick={() => onGoNext()}>
                    <svg aria-label="Next" color="#fff" style={{ rotate: "90deg" }}
                        fill="#fff" height="20" role="img"
